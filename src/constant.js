...
const constant = [
...

  {
      ...
      paragraph4: "Udaipur symbolises an important city of India at the crossroads of growing urbanism and traditional sensibilities, a place where culture",
...

  {
      ...
      paragraph5: "We believe in increasing awareness to advance the safety, financial independence, education and empowerment of women in Udaipur. #SheIsUdaipur is an initiative to empower women to share their stories. When women share their stories of personal triumph, they often have the potential to give hope, to inspire and to help change lives. Visit sheisudaipur.org to read interesting stories of the top 100 #SheIsUdaipur 2019 winners.",
      images3: udaipurImages,
  },
...

  {
     ...
     paragraph6 : "At Arcgate Foundation, we care about the oral health and well-being of our community. That's why we supported a free dental camp in collaboration with the Udaipur Dental Clinic for specially-abled children and those who need extra help.",
     paragraph7 : "The camp provided dental check-ups, treatments, and education to hundreds of children who otherwise would not have access to quality dental care.",
     paragraph8 : "We are proud to be part of this initiative and to make our city a better place to live and work. We hope that our efforts will inspire others to join us in making a positive difference in our community. Together, we can create a more beautiful and livable city for ourselves and future generations.",
     images5: campImages,
  },
...

  {
     ...
     paragraph9: "Arcgate Foundation donated several advanced NICU machines to Bhandari Children Hospital in Udaipur, a leading facility for neonatal care in the region. NICU machines are essential equipment for the survival and well-being of premature and critically ill newborns. They include neonatal incubators and ventilators.",
     paragraph10 : "These machines help regulate the temperature, oxygen level, breathing, feeding and infection control of the babies in the NICU. With these machines, the hospital can provide better care and outcomes for the most vulnerable patients.",
     paragraph11 : "We are honored to support Bhandari Children Hospital in their mission to save lives and improve the health of newborns. We believe that every child deserves a chance to grow and thrive. We hope that our contribution will make a difference in the lives of many children, families and communities.",
     images6 : helpImages,
  },
...

  {
      ...
      paragraph12: "At Arcgate Foundation, we value the spirit of adventure and service that the Hindustan Scouts & Guides embody. That's why we are proud to support this organization, which has been nurturing the youth of India since 1951..",
      paragraph13 : "The Hindustan Scouts & Guides offer various programs and activities that help young people develop their physical, mental, and social skills, as well as their sense of responsibility and citizenship.",
      paragraph14 : "They also encourage them to explore nature, culture, and heritage, and to contribute to the welfare of society. We are honored to be part of their mission and to help them shape the future leaders of India..",
      images7 : functionImages,
  },


  {
      heading11: "Celebrating the legacy of music maestro Pt. Chatur Lal with Smritiyaan",
      paragraph15: "We are passionate about preserving and promoting the rich heritage of Indian Classical Music. That's why Arcgate Foundation is proud to support Smritiyaan, a concert dedicated to the memory and achievements of Pt. Chatur Lal, the legendary tabla maestro who introduced Indian percussion to the world.",
      paragraph16 : "Smritiyaan featured some of the finest artists of Indian Classical Music, who paid tribute to Pt. Chatur Lal's musical genius and innovation. The concert showcased the diversity and beauty of Indian Classical Music, and inspired the next generation of musicians and listeners.",
      paragraph17 : "We are honored to be part of this initiative and to celebrate the legacy of Pt. Chatur Lal with Smritiyaan. We hope that our support will help preserve and promote the rich tradition of Indian Classical Music and its eminent exponents.",
  },
...

  {
      ...
      paragraph24 : "We believe in supporting rural development and governance initiatives that can improve the lives and livelihoods of millions of people in India. That's why we decided to take up a rewarding project to repair and renovate the Gram Panchayat office for Sisarma village in Udaipur, Rajasthan.",
      paragraph25 : "We upgraded and expanded the existing building with all the necessary facilities and amenities for the village administration and the public. We did this project to support the region's development goals and to demonstrate our commitment to social responsibility.",
      paragraph26 : "The village leaders and residents were very happy and thankful for our generous contribution, which has made their quality of life and civic engagement better. They appreciated our efforts to provide them with a modern and comfortable space for conducting their affairs and accessing various government schemes and services. We are proud to share our values and expertise with the rural community and hope to empower more villagers to access digital services and opportunities that can enhance their well-being and prosperity.",
      images10 : foundationImages,
  },

  {
      heading15 : "Supporting Usanas Foundation’s efforts to promote geopolitics dialogue",
